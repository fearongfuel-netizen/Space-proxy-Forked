...
const proxy = (url, type = "application/javascript") => async (req, reply) => {
  ...
  try {
    ...
    const headersToStrip = [
      ...
      'x-content-type-options', 'cross-origin-embedder-policy', 'cross-origin-opener-policy',
      'cross-origin-resource-policy', 'strict-transport-security', 'set-cookie', 'server',
      'x-powered-by', 'x-ua-compatible', 'x-forwarded-for', 'x-real-ip', 'referer', 'user-agent',
    ];
...
// THIS IS THE CRITICAL CHANGE: Listen on 0.0.0.0
